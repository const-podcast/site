...
Elm.Models.Episode.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Episode = F3(function (a,b,c) {    return {title: a,guests: b,summary: c};});
   return _elm.Models.Episode.values = {_op: _op,Episode: Episode};
};
Elm.Data = Elm.Data || {};
...
Elm.Data.Episodes.CodeSounds.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var codeSounds = {title: "Code Sounds",guests: _U.list(["Ethan Winograd"]),summary: "TODO.."};
   return _elm.Data.Episodes.CodeSounds.values = {_op: _op,codeSounds: codeSounds};
};
Elm.Data = Elm.Data || {};
Elm.Data.Episodes = Elm.Data.Episodes || {};
Elm.Data.Episodes.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Data$Episodes$CodeSounds = Elm.Data.Episodes.CodeSounds.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models$Episode = Elm.Models.Episode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var orderedEpisodes = _U.list([$Data$Episodes$CodeSounds.codeSounds]);
...
Elm.Main.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("const (the Podcast)")]))
              ,A2($Html.ul,
              _U.list([]),
              A2($List.map,$Html.li(_U.list([])),A2($List.map,function (x) {    return _U.list([$Html.text(x.title)]);},$Data$Episodes.orderedEpisodes)))]));
   });
   var model = 0;
