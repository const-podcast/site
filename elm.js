...
Elm.Style.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var setToString = function (_p0) {
      var _p1 = _p0;
      var body = $String.concat(A2($List.map,
      function (_p2) {
         var _p3 = _p2;
         return A2($Basics._op["++"],_p3._0,A2($Basics._op["++"],":",A2($Basics._op["++"],_p3._1,";")));
      },
      _p1._1));
      return A2($Basics._op["++"],_p1._0,A2($Basics._op["++"],"{",A2($Basics._op["++"],body,"}")));
   };
   var rules = function (sets) {    return $String.concat(A2($List.map,setToString,sets));};
   return _elm.Style.values = {_op: _op,rules: rules};
};
...
Elm.Common.Styles = Elm.Common.Styles || {};
Elm.Common.Styles.make = function (_elm) {
   "use strict";
   _elm.Common = _elm.Common || {};
   _elm.Common.Styles = _elm.Common.Styles || {};
   if (_elm.Common.Styles.values) return _elm.Common.Styles.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var linkStyle = _U.list([{ctor: "_Tuple2",_0: "text-decoration",_1: "underline"}
                           ,{ctor: "_Tuple2",_0: "color",_1: "blue"}
                           ,{ctor: "_Tuple2",_0: "cursor",_1: "pointer"}]);
   return _elm.Common.Styles.values = {_op: _op,linkStyle: linkStyle};
};
Elm.Models = Elm.Models || {};
Elm.Models.Episode = Elm.Models.Episode || {};
Elm.Models.Episode.make = function (_elm) {
   "use strict";
   _elm.Models = _elm.Models || {};
   _elm.Models.Episode = _elm.Models.Episode || {};
   if (_elm.Models.Episode.values) return _elm.Models.Episode.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var joinCommaAnd = function (values) {
      ...
      if (_p0.ctor === "[]") {
            ...
            if (_p0._1.ctor === "[]") {
                  ...
                  if (_p0._1._1.ctor === "[]") {
                        return A2($Basics._op["++"],_p0._0,A2($Basics._op["++"]," and ",_p0._1._0));
                     } else {
                        return A2($Basics._op["++"],_p0._0,A2($Basics._op["++"],", ",joinCommaAnd(A2($List._op["::"],_p0._1._0,_p0._1._1))));
                     }
               }
         }
   };
   var formatGuests = function (guests) {
      var _p1 = guests;
      if (_p1.ctor === "[]") {
            return "";
         } else {
   ...
   var episodeNumber = function (episode) {
      return $String.concat(_U.list(["s"
                                    ,A3($String.padLeft,2,_U.chr("0"),$Basics.toString(episode.season))
                                    ,"e"
                                    ,A3($String.padLeft,2,_U.chr("0"),$Basics.toString(episode.episodeOfSeason))]));
   };
...
Elm.Data.Episodes.CodeSounds.make = function (_elm) {
   "use strict";
   _elm.Data = _elm.Data || {};
   _elm.Data.Episodes = _elm.Data.Episodes || {};
   _elm.Data.Episodes.CodeSounds = _elm.Data.Episodes.CodeSounds || {};
   if (_elm.Data.Episodes.CodeSounds.values) return _elm.Data.Episodes.CodeSounds.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Data = Elm.Data || {};
Elm.Data.Episodes = Elm.Data.Episodes || {};
Elm.Data.Episodes.ConfidenceInCode = Elm.Data.Episodes.ConfidenceInCode || {};
Elm.Data.Episodes.ConfidenceInCode.make = function (_elm) {
   "use strict";
   _elm.Data = _elm.Data || {};
   _elm.Data.Episodes = _elm.Data.Episodes || {};
   _elm.Data.Episodes.ConfidenceInCode = _elm.Data.Episodes.ConfidenceInCode || {};
   if (_elm.Data.Episodes.ConfidenceInCode.values) return _elm.Data.Episodes.ConfidenceInCode.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Data = Elm.Data || {};
Elm.Data.Episodes = Elm.Data.Episodes || {};
Elm.Data.Episodes.Queues = Elm.Data.Episodes.Queues || {};
Elm.Data.Episodes.Queues.make = function (_elm) {
   "use strict";
   _elm.Data = _elm.Data || {};
   _elm.Data.Episodes = _elm.Data.Episodes || {};
   _elm.Data.Episodes.Queues = _elm.Data.Episodes.Queues || {};
   if (_elm.Data.Episodes.Queues.values) return _elm.Data.Episodes.Queues.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Data = Elm.Data || {};
Elm.Data.Episodes = Elm.Data.Episodes || {};
Elm.Data.Episodes.SoftwareEngineeringLaws = Elm.Data.Episodes.SoftwareEngineeringLaws || {};
Elm.Data.Episodes.SoftwareEngineeringLaws.make = function (_elm) {
   "use strict";
   _elm.Data = _elm.Data || {};
   _elm.Data.Episodes = _elm.Data.Episodes || {};
   _elm.Data.Episodes.SoftwareEngineeringLaws = _elm.Data.Episodes.SoftwareEngineeringLaws || {};
   if (_elm.Data.Episodes.SoftwareEngineeringLaws.values) return _elm.Data.Episodes.SoftwareEngineeringLaws.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   return _elm.Data.Episodes.SoftwareEngineeringLaws.values = {_op: _op,episode: episode};
};
Elm.Data = Elm.Data || {};
Elm.Data.Episodes = Elm.Data.Episodes || {};
Elm.Data.Episodes.TheGrind = Elm.Data.Episodes.TheGrind || {};
Elm.Data.Episodes.TheGrind.make = function (_elm) {
   "use strict";
   _elm.Data = _elm.Data || {};
   _elm.Data.Episodes = _elm.Data.Episodes || {};
   _elm.Data.Episodes.TheGrind = _elm.Data.Episodes.TheGrind || {};
   if (_elm.Data.Episodes.TheGrind.values) return _elm.Data.Episodes.TheGrind.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Data = Elm.Data || {};
Elm.Data.Episodes = Elm.Data.Episodes || {};
Elm.Data.Episodes.TheQaDeveloperRelationship = Elm.Data.Episodes.TheQaDeveloperRelationship || {};
Elm.Data.Episodes.TheQaDeveloperRelationship.make = function (_elm) {
   "use strict";
   _elm.Data = _elm.Data || {};
   _elm.Data.Episodes = _elm.Data.Episodes || {};
   _elm.Data.Episodes.TheQaDeveloperRelationship = _elm.Data.Episodes.TheQaDeveloperRelationship || {};
   if (_elm.Data.Episodes.TheQaDeveloperRelationship.values) return _elm.Data.Episodes.TheQaDeveloperRelationship.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Data = Elm.Data || {};
Elm.Data.Episodes = Elm.Data.Episodes || {};
Elm.Data.Episodes.make = function (_elm) {
   "use strict";
   _elm.Data = _elm.Data || {};
   _elm.Data.Episodes = _elm.Data.Episodes || {};
   if (_elm.Data.Episodes.values) return _elm.Data.Episodes.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Data$Episodes$SoftwareEngineeringLaws = Elm.Data.Episodes.SoftwareEngineeringLaws.make(_elm),
   $Data$Episodes$TheGrind = Elm.Data.Episodes.TheGrind.make(_elm),
   $Data$Episodes$TheQaDeveloperRelationship = Elm.Data.Episodes.TheQaDeveloperRelationship.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models$Episode = Elm.Models.Episode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var orderedEpisodes = _U.list([$Data$Episodes$TheQaDeveloperRelationship.episode
                                 ,$Data$Episodes$SoftwareEngineeringLaws.episode
                                 ,$Data$Episodes$TheGrind.episode]);
   return _elm.Data.Episodes.values = {_op: _op,orderedEpisodes: orderedEpisodes};
};
Elm.Components = Elm.Components || {};
Elm.Components.EpisodeList = Elm.Components.EpisodeList || {};
Elm.Components.EpisodeList.make = function (_elm) {
   "use strict";
   _elm.Components = _elm.Components || {};
   _elm.Components.EpisodeList = _elm.Components.EpisodeList || {};
   ...
   var by = function (identifier) {
      ...
      function (ep) {
         return A2(F2(function (x,y) {    return _U.eq(x,y);}),identifier,ep.identifier);
      },
      $Data$Episodes.orderedEpisodes);
      var _p0 = matches;
      if (_p0.ctor === "[]") {
            return $Maybe.Nothing;
         } else {
   ...
   var episodeLink = F2(function (address,episode) {
      ...
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "border-radius",_1: "6px"}
                                              ...
                                              ,{ctor: "_Tuple2",_0: "min-height",_1: "85px"}]))]),
      _U.list([A2($Html.img,
...
Elm.Components.Header.make = function (_elm) {
   "use strict";
   _elm.Components = _elm.Components || {};
   _elm.Components.Header = _elm.Components.Header || {};
   if (_elm.Components.Header.values) return _elm.Components.Header.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding-left",_1: "2em"}
                                           ,{ctor: "_Tuple2",_0: "padding-top",_1: "0.5em"}
                                           ,{ctor: "_Tuple2",_0: "height",_1: "100%"}]))]),
   _U.list([A2($Html.p,
   _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "color",_1: "#F3953B"}
...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var appWideStyle = $Style.rules(_U.list([{ctor: "_Tuple2"
                                            ,_0: "body"
                                            ,_1: _U.list([{ctor: "_Tuple2",_0: "background",_1: "url(/images/bg.jpeg)"}
                                                         ,{ctor: "_Tuple2",_0: "background-size",_1: "cover"}])}]));
   var update = F2(function (action,_p0) {
      var _p1 = action;
      if (_p1.ctor === "ListAction") {
            return {ctor: "_Tuple2",_0: $Maybe.Just(_p1._0._0),_1: $Effects.none};
         } else {
            return {ctor: "_Tuple2",_0: $Maybe.Nothing,_1: $Effects.none};
         }
   });
   var UnknownEpisodeSought = function (a) {    return {ctor: "UnknownEpisodeSought",_0: a};};
   var ListAction = function (a) {    return {ctor: "ListAction",_0: a};};
   var NavigateToEpisodeList = {ctor: "NavigateToEpisodeList"};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "",_1: ""}]))]),
      _U.list([$Components$Header.view
              ,A2($Html.div,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding-left",_1: "50%"}
                                                      ,{ctor: "_Tuple2",_0: "padding-right",_1: "10%"}
                                                      ,{ctor: "_Tuple2",_0: "padding-top",_1: "1em"}]))]),
              _U.list([function () {
                 var _p2 = model;
                 if (_p2.ctor === "Nothing") {
                       return A2($Components$EpisodeList.view,A2($Signal.forwardTo,address,ListAction),model);
                    } else {
                       return A2($Html.div,
                       _U.list([]),
                       _U.list([A2($Html.a,
   ...
   var location2action = function (location) {
      var _p3 = location;
      if (_p3.ctor === "::" && _p3._0 === "episode" && _p3._1.ctor === "::" && _p3._1._1.ctor === "[]") {
            var _p5 = _p3._1._0;
            ...
            return _U.list([NavigateToEpisodeList]);
         }
   };
   var delta2update = F2(function (_p6,$new) {
      return $Maybe.Just(function () {
         var _p7 = $new;
         if (_p7.ctor === "Just") {
               return $RouteHash.set(_U.list(["episode",_p7._0.identifier]));
            } else {
               return $RouteHash.set(_U.list(["episodes"]));
            }
      }());
   });
